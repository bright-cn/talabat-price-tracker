...
[![Talabat Price Tracker](https://img.shields.io/badge/Talabat%20Price%20Tracker-Managed%20Solution-orange?style=flat-square)](https://bright.cn/products/insights/price-tracker/talabat)
[![Python](https://img.shields.io/badge/Python-3.9%2B-yellow?style=flat-square)](https://python.org)

[![Bright Insights Price Tracker](https://raw.githubusercontent.com/danielshashko/bright-insights-assets/main/price-tracker-hero-v2.png)](https://bright.cn/products/insights/price-tracker/talabat)

Talabat 实时价格追踪——中东领先的食品配送平台。提供两种入门方式：**全托管**情报平台，或使用 Bright Data 的 AI Scraper Builder 构建的**自定义 scraper**。

---

## 选项 1：Bright Insights - AI 驱动的价格追踪（推荐）

**[Bright Insights](https://bright.cn/products/insights/price-tracker/talabat)** 是 Bright Data 的全托管零售情报平台。无需构建 scraper，无需维护基础设施——只需将结构化、可直接分析的价格数据交付到仪表板、数据 feed 或您的 BI 工具中。
...
> **每月 $250 起 —— [获取定制报价 →](https://bright.cn/products/insights/price-tracker/talabat)**

---

## 选项 2：构建您自己的 Talabat Scraper

没有预构建的 Talabat scraper API？没问题。Bright Data 的 **AI Scraper Builder** 只需点击几下即可生成自定义 Talabat scraper——无需编写代码。

### 几分钟内构建您的 Talabat scraper

**[打开 Talabat AI Scraper Builder →](https://bright.cn/products/web-scraper/talabat)**
...
- 一个用于 Talabat 的 **Web Scraper ID**（来自上面的构建步骤）
...
1. **克隆此 repository**
   ...
   ```bash
   git clone https://github.com/bright-cn/talabat-price-tracker.git
...
3. **配置凭据**
   ...
   > **您的 Web Scraper ID**
   > 将您在 [AI Scraper Builder dashboard](https://bright.cn/products/web-scraper/talabat) 中的 Web Scraper ID
...
一旦您的 Talabat scraper 构建完成，并且已在 `.env` 中配置好 Web Scraper ID，Python 接口的工作方式相同：

### 1. 通过 URL 追踪特定商品

传入 Talabat 商品 URL 列表以获取结构化价格数据：
...
- 🌟 [Talabat Price Tracker - Bright Insights (Managed)](https://bright.cn/products/insights/price-tracker/talabat)
- 🏗️ [Build a Talabat Scraper](https://bright.cn/products/web-scraper/talabat)
